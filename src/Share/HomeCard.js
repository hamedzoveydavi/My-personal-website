...
import img from "../assets/images/about/avatar1.png";
  ...
  return (
    <div>
      <div className="w-full mb-6 lg:mb-0  mx-auto   relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        <img
          src={img}
          className="w-[300px] absolute left-[50%] transform -translate-x-[50%] h-[300px] drop-shadow-xl mx-auto  rounded-[20px] -mt-[140px]"
          alt=""
        />
        {/* Social card */}
        <div className="pt-[100px] pb-8">
          ...
          <div className="flex justify-center space-x-3">
            ...
            <a
              href="https://linkedin.com/in/hamed-zoveydavi"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="p-7 rounded-2xl mt-7  bg-[#F3F6F6] dark:bg-[#1D1D1D]">
            ...
            <div className="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="dark:text-white break-all">Iran , Tehran</p>
              </div>
            </div>
            ...
            <div className="flex  py-2.5">
              ...
              <div className="text-left ml-2.5">
                ...
                <p className="dark:text-white break-all">Aug 03, 1985</p>
              </div>
            </div>
          </div>
